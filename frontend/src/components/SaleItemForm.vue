      ...
      <div class="md:flex md:space-x-8">
        ...
        <div class="md:w-2/3">
          ...
          <div class="mb-4">
            ...
            <input id="screenSize" type="number" v-model.number="form.screenSizeInch" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
          </div>
